...
DATA_TYPES = [
    ...
    },
    {
        ...
        "description": "Trade records aggregated by price level. Combines multiple trades at same price.",
        "requires_futures": False,
        "min_interval": "tick",
        "supported": True,  # Implemented for Binance spot/futures
    },
    {
        "id": "trades",
        "name": "Tick Trades",
        "description": "Detailed record of each individual trade with unique trade ID.",
        "requires_futures": False,
        "min_interval": "tick",
        "supported": True,  # Implemented for Binance spot/futures
    },
    {
        ...
        "description": "Order book bid/ask snapshot with depth metrics and spread analysis.",
        "requires_futures": False,
